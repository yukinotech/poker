...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--buy-ins", type=int, default=3, help="每位玩家可买入次数，1–10（默认：3）")
...
def main() -> None:
    ...
    try:
        PokerGame(starting_chips=args.chips, opponents=args.opponents, buy_ins=args.buy_ins, seed=args.seed).play()
